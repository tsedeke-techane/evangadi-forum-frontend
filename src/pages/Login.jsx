            ...
            <div className="form-card">
              ...
              <form onSubmit={handleSubmit} className="login-form">
                <div className="form-group">
                  <input ref={userEmail} type="email" name="email" placeholder="Your Email" className="form-input" />
                </div>
                ...
                <button type="submit" className="submit-button orange-button">
                  submit
                </button>
          ...
          <div className="content-section">
            <div className="content-container">
              ...
              <div className="content-paragraphs">
                ...
                <p className="content-paragraph">
                  Lorem ipsum dolor sit amet consectetur adipiscing elit. Ulam ipsum, provident minus laudantium esse
                  soluta maiores nostrum nisi sunt perferendis dolorum. Praesentium necessitatibus quia consectetur sunt
                  tempora possimus eveniet voluptates?
                </p>
                <div>
